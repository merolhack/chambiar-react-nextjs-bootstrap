      ...
      <Card className="bg-white border-0 rounded-3 mb-4">
        <Card.Body className="p-4">
          <div className="d-flex justify-content-between align-items-center flex-wrap gap-3 pb-4">
            <h3 className="mb-0">Work distribution aligned with KPI</h3>
          ...
          <div className="d-flex justify-content-center flex-wrap gap-3 gap-lg-4">
            <div>
              ...
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Maria</h4>
            </div>
            ...
            <div>
              ...
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Stephanie</h4>
            </div>

            <div>
              <div className="d-flex align-items-center">
                <span className="wh-11 bg-primary-div rounded-1 me-1"></span>
                <span>Efficient Revenue Growth</span>
              </div>
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Francisco</h4>
            </div>
            ...
            <div>
              ...
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Vanessa</h4>
            </div>
            ...
            <div>
              ...
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Erika</h4>
            </div>
            ...
            <div>
              ...
              <h4 className="fs-18 fw-medium mb-0 mt-1 ps-3">Olivia</h4>
            </div>
          </div>
        </Card.Body>
      </Card>
