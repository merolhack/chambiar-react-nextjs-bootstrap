...
const ClicksByKeywords = () => {
  const data = [
    {
      id: 1,
      dimension: "Project work is heavy",
      impressions: 85,
      clicks: "6 hrs",
    },
    {
      id: 2,
      dimension: "Too many meetings",
      impressions: 300,
      clicks: "7 hrs",
    },
    {
      id: 3,
      dimension: "Training is strong",
      impressions: 146,
      clicks: "5 hrs",
    },
    {
      id: 4,
      dimension: "Admin load high",
      impressions: 200,
      clicks: "4 hrs",
    },
    {
      id: 5,
      dimension: "Skills misused",
      impressions: 195,
      clicks: "20 hrs",
    },
    {
      id: 6,
      dimension: "Meetings drag",
      impressions: 241,
      clicks: "50 hrs",
    },
    {
      id: 7,
      dimension: "Learning applied",
      impressions: 134,
      clicks: "10 hrs",
    },
    {
      id: 8,
      dimension: "Admin ripe",
      impressions: 295,
      clicks: "30 hrs",
    },
    {
    ...
    <Card className="bg-white border-0 rounded-3 mb-4">
      <Card.Body className="p-4">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-3 pb-4">
          <h3 className="mb-0">Insights & Recommendations</h3>
